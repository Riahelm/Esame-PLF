...
calcolaVett lx i nu dx dt  | i == 0                = (estrai lx i) - (estrai lx i) * dt/dx * ((estrai lx i) - (estrai lx (lunghezza lx))) + nu*dt/dx**2 * ((estrai lx (i+1)) - 2*(estrai lx i) + (estrai lx (lunghezza lx))) : calcolaVett lx (i+1) nu dx dt
                           ...
                           | otherwise             = ((estrai lx i)  - (estrai lx i) * dt/dx * ((estrai lx i) - (estrai lx (i-1))) + nu*dt/dx**2*((estrai lx (i+1)) - 2*(estrai lx i) + (estrai lx (i-1)))) : calcolaVett lx (i+1) nu dx dt
...
-- test su calcolaVett
second_calculate = calcolaVett (wave (linspace 201 0 6.28 201) 0 0.07 ) 0 nu dx dt 
