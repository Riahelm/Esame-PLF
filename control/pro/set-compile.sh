...
#src/master/modulo/main.hs -- main.hs
...
#ghc src/convezione/modulo/*.hs src/master/modulo/main.hs -o convezione
...
#ghc src/convezione/modulo/funzioni_ausiliarie.hs src/burgers/modulo/*.hs src/master/modulo/main.hs -o burgers

ghc src/fugoide/completo/modulo/*.hs src/fugoide/semplice/modulo/*.hs src/convezione/modulo/*.hs src/burgers/modulo/*.hs src/master/modulo/main.hs -o fugconvburgers

#!/bin/bash

#rm -r <name_directory>/*.{<list extensions>}
rm -r  src/master/modulo/*.{o,hi}
