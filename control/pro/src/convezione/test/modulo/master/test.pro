...
main :-
   ...
   %                                                                              write(L1), nl,
    ...
    write('gen_punti_equi( 5,   0,   1, L3). '), gen_punti_equi(05,0,01,L3),                 nl,
                                                                                  write(L3), nl,
    write('gen_punti_equi( 5,   1,   0, L9). '), gen_punti_equi(05,01,0,L9),                 nl,
                                                                                  write(L9), nl, 
    write('gen_punti_equi( 8,   7,  -1, R9). '), gen_punti_equi(08,7,-1,R9),                 nl,
                                                                                  write(R9), nl,  
    nl,
    ...
    write('NX is 41, INF is 0.0, SUP is 2.0, cond_iniziale_conv(NX, INF, SUP, L).        '), nl, 
           NX is 41, INF is 0.0, SUP is 2.0, cond_iniziale_conv(NX, INF, SUP, M),  write(M), nl,
    ...
    write('C is 1.0, DX is SUP / (NX - 1), DT is 0.02, passo_eulero_conv(1,2,C,DX,DT,EU).'), nl,
           C is 1.0, DX is SUP / (NX - 1), DT is 0.02, passo_eulero_conv(1,2,C,DX,DT,EU),
                                                                                  write(EU), nl,
    nl,
    ...
    write('spazio_conv(I,NX1,C,DX,DT,M,F), conta(F,0,K). K=40                            '), nl,
           I is 0, NX1 is NX - 1,
           spazio_conv(I,NX1,C,DX,DT,M,F), conta(F,0,K),              write(F), write('K='),
                                                                                   write(K), nl,
    write('K1 is 0, NT is 25, NX1 is NX - 1, DX is SUP / (NX1), DT is 0.02.              '), nl,
    write('tempo_conv(K1,NT,NX1,C,DX,DT,M,G), conta(G,0,Z). Z=41                         '), nl,
           K1 is 0, NT is 25,
           tempo_conv(K1,NT,NX1,C,DX,DT,M,G), conta(G,0,Z), write(G), write('Z='), write(Z), nl,
    nl,
