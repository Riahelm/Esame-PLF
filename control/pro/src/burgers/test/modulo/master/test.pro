...
main :-
   ...
   %                                                                              write(L1), nl,
    ...
    write('NX is 201, INF is 0.0, SUP is 2.0 * pi, cond_iniziale(NX, INF, SUP, L).       '), nl, 
           NX is 201, INF is 0.0, SUP is 2.0 * pi, cond_iniziale(NX, INF, SUP, M), write(M), nl,
   ...
   %                                                                              write(EU), nl,
    write('I is 1, NU is 0.07, DX is 0.0314, DT is 0.0014, passo_eulero(M,I,NU,DX,DT,EU) '), nl,
           I is 1, NU is 0.07, DX is 0.0314, DT is 0.0014, passo_eulero(M,I,NU,DX,DT,EU),
                                                                                  write(EU), nl,
    nl,
    ...
    write('conv_spazio(I,NX1,NU,DX,DT,M,F), conta(F,0,K). K=200                          '), nl,
           I is 1, NX1 is 201 - 1, NU is 0.07, DX is 0.0314, DT is 0.0014,
           conv_spazio(I,NX1,NU,DX,DT,M,F), conta(F,0,K),   write(F), write('K='), write(K),  nl,
    write('K1 is 0, NT is 425, NX1 is 201 - 1, NU is 0.07, DX is 0.0314, DT is 0.0014,    '), nl,
    write('conv_tempo(K1,NT,NX1,NU,DX,DT,M,G), conta(G,0,Z). Z=201                        '), nl,
           K1 is 0, NT is 425, NX1 is 201 - 1, NU is 0.07, DX is 0.0314, DT is 0.0014,
           conv_tempo(K1,NT,NX1,NU,DX,DT,M,G), conta(G,0,Z), write(G), write('Z='), write(Z), nl,
    nl,
